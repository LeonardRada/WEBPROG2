<?php
  ...
  function recordOrder($tireQty, $oilQty, $sparkQty, $totalAmount){
    ...
    $file = @fopen(DOCUMENT_ROOT.'/llama-php-my-works/bobs-view/resource/order.txt',
  ...
  function getOrders(){
    ...
    try {
      $file = @fopen(DOCUMENT_ROOT.'/llama-php-my-works/bobs-view/resource/order.txt', 'rb');
      if(!$file){
